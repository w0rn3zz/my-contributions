...
- **98 коммитов (non-merge)** от `w0rn3zz <w0rn3zz@gmail.com>`;
- **1 051 изменение файлов**, суммарно **30 030** добавленных и **11 655** удалённых строк во всех этих коммитах;
...
## Адаптивное обучение и качество AI-оценки

- добавил адаптивный Профиль ошибок и персональный feedback после завершённого Прохождения;
- реализовал безопасную рекомендацию опубликованной Темы по обезличенному Снимку диалога Avito без хранения переписки и без вызова модели;
- выделил конфигурацию, DTO и границы AI provider-а, а зависимости приложения — в отдельные модули композиции;
- добавил закрытый Набор оценки Evaluator-а и проверки устойчивости к коротким отказам, инверсии смысла и неоднозначным Ответам пользователя;
- сохранил исторические Сценарии при полировке демо-диалогов и добавил миграции адаптивного обучения.

Исходные коммиты: [`5fc9c33`](https://github.com/Codiki-lab/anti-scam-trainer/commit/5fc9c333dc33729dbee1ea644926b391859f3fcc), [`b4d0036`](https://github.com/Codiki-lab/anti-scam-trainer/commit/b4d0036b65dce7d1eee51d9004a48b0c128d478d), [`5cae0d0`](https://github.com/Codiki-lab/anti-scam-trainer/commit/5cae0d0460db2ce44473f99af46ff8680ce0fe64), [`aa46542`](https://github.com/Codiki-lab/anti-scam-trainer/commit/aa4654292df0f6ffa02900e24d79963a38b19ff3).
...
├── current/                          # 271 файл в актуальном состоянии
└── historical/                       # 72 перенесённых/удалённых исходника с provenance
provenance/
├── original-commits.patch           # точные патчи ключевых личных коммитов
└── commit-index.md                  # все 98 прямых личных коммитов со ссылками
```
